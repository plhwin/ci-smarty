...
function AjaxRequest(recvType, waitId) {
	...
	aj.showLoading = function() {
		if(aj.waitId && (aj.XMLHttpRequest.readyState != 4 || aj.XMLHttpRequest.status != 200)) {
			...
			aj.waitId.innerHTML = '<span><img src="'+SITE_URL+'/resource/default/images/ico_pending.gif"> ' + aj.loading + '</span>';
		}
	}
...
function ajaxmenu(e, ctrlid, title, timeout, func) {
	...
	var dialogHTML = '<DIV style="width:450px;text-align:center;font-size:14px; padding:30px 0 30px"><img src="'+SITE_URL+'/resource/default/images/ico_pending.gif" border="0" align="absmiddle" /> 正在加载中,请稍后...</div>';
