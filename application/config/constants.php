...
define('SITE_URL', $PHP_SCHEME.$_SERVER['HTTP_HOST'].$PHP_PORT.SITE_PATH);
define('SCRIPT_URL', $PHP_SCHEME.$_SERVER['HTTP_HOST'].$PHP_PORT.$PHP_PATH.($_SERVER['QUERY_STRING'] ? '?'.$_SERVER['QUERY_STRING'] : ''));
...
|--------------------------------------------------------------------------
*/
define("CACHE_DATA", SITE_ROOT.'/application/cache/data');
...
//数据库名
define('DB_CORE', 'ci_smarty');

//数据表前缀
define('DB_CORE_PREFIX', 'ci_');
/*
|--------------------------------------------------------------------------
...
|--------------------------------------------------------------------------
*/
define('ICON_OK', '<img align="absmiddle" src="'.PATH_IMAGES.'/showmessage/ico_ok.gif" /> ');
define('ICON_ERROR', '<img align="absmiddle" src="'.PATH_IMAGES.'/showmessage/ico_error.gif" /> ');
...
//模板编译目录
define('SMARTY_COMPILE_DIR', SITE_ROOT . '/application/cache/templates_c');
//模板缓存目录
define('SMARTY_CACHE_DIR', SITE_ROOT . '/application/cache/cache');
//模板配置目录
